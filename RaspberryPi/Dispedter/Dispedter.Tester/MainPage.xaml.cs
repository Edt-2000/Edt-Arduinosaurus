...
namespace Dispedter.Tester
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private readonly SenderManager _senderManager = new SenderManager(detectUsb: true, udpDestinations: new[] { IPAddress.Parse("192.168.1.122")/*IPAddress.Parse("169.254.219.93")*/ });
