...
// EdtRGBLED::EdtRGBLED(const char *pattern, uint8_t const nrOfLeds) : StructMessageConsumer(12)
// {
//     _pattern = pattern;
...
// const char *EdtRGBLED::pattern()
// {
//     return _pattern;
// }

// // template <uint8_t dataPin, uint8_t clockPin>
// // void EdtRGBLED::configurePins()
// // {
...
// void EdtRGBLED::callbackEnum(OSC::ColorCommands command)
// {
